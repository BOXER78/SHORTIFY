...
const AppLayout = () => {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-zinc-500 opacity-10 blur-[100px]"></div>
      ...
      <footer className="p-10 text-center border-t border-white/10 mt-10 backdrop-blur-md bg-black/20">
        <p className="text-gray-400 font-medium">
          &copy; {new Date().getFullYear()} <span className="text-zinc-300 font-bold">Shortify</span>. Simplify your digital footprint.
        </p>
      </footer>
    </div>
  );
